...
(canTestReactiveElement ? suite : suite.skip)('@queryAssignedElements', () => {
  ...
  class D extends RenderingElement {
    ...
    @queryAssignedElements('footer', {flatten: true})
    footerAssigned!: Element[];

    @queryAssignedElements('footer', {flatten: false})
  ...
  class E extends RenderingElement {
    ...
    @queryAssignedElements('header') headerAssigned!: Element[];
  ...
  class S extends RenderingElement {
    ...
    @queryAssignedElements('header') [headerSymbol]!: Element[];
